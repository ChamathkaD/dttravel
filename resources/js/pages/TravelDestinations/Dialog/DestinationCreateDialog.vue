...
const handleCreateDestination = () => {
  ...
  form.post(route('travel-destinations.store'), {
    onSuccess: () => {
      isDialogVisible.value = false
      Notify.success('Destination Added Successfully!')
      form.reset()
      clearPhotoFileInput()
      nameInput.value = ''
      slugInput.value = ''
...
<template>
  ...
  >
    ...
    >
      <VForm @submit.prevent="handleCreateDestination">
        <VCardText>
          <VRow>
            <VCol cols="12">
              <AppTextField
            ...
            <VCol cols="12">
              <AppSelect
                v-model="form.parent_destination"
                clearable
                :items="destinations"
                item-title="name"
                item-value="id"
                ...
                :error-messages="form.errors.parent_destination"
              />
            </VCol>
                    ...
                    <div>
                      ...
                      >
                        <VIcon
                          ...
                          class="d-sm-none"
                        />
                        <span class="d-none d-sm-block">Upload Destination Image</span>
                      </VBtn>
