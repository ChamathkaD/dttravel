    ...
    <VRow class="d-flex justify-center pa-10">
      ...
      >
        <VCard class="mb-2">
          ...
          <VCardText class="print-row" v-if="booking.booking_travelers.length !== 0">
            <div class="ms-sm-4">
          ...
          >
            <VCardText>
              <div class="d-flex flex-wrap align-center items-center ms-4">
                <VAvatar
                  v-if="agent"
                  size="32"
                ...
                >
                  ...
                  />
                  <span v-else>{{ agent ? avatarText(agent.full_name.split(' ').slice(0, 2).join(' ')) : null }}</span>
                </VAvatar>
                <div class="d-flex flex-column ms-3">
                  <span class="d-block font-weight-medium text-high-emphasis text-truncate"
                  >{{ agent ? agent.full_name : '-' }}</span>
                  <span class="text-sm text-medium-emphasis">
                    Customer ID: # {{ agent ? agent.id : '-' }}
                  </span>
                </div>
              </div>
