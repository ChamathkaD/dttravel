                                ...
                                <tr>
                                    ...
                                    >
                                        ...
                                        <p style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; margin: 0; margin-top: 24px; margin-bottom: 24px;">
                                            You are receiving this email because you have to pay for your booking.
                                        </p>
                                        ...
                                        >
                                            <tr>
                                                <td style="mso-line-height-rule: exactly; mso-padding-alt: 16px 24px; border-radius: 4px; background-color: #fd9f12; margin-top: 16px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;">
                                                    <a href="{{ $payment_url }}"
                                                       style="font-family: 'Montserrat', sans-serif; mso-line-height-rule: exactly; display: block; padding: 16px 24px;font-size: 16px; font-weight: 600; line-height: 100%; color: #000; text-decoration: none;"
                                                    >Click to Pay
                                                        &rarr;</a>
                                                </td>
                                            </tr>
